    ...
    layui.use(['table', 'form', 'layer'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'noticeName', width:250, title: '公告主题'}
                ,{field:'noticeContent', width:700, title: '公告内容', sort: true}
                ,{field:'noticeTime', width:250, title: '发布时间'}
            ]]
            ,page: true
        });
        ...
        table.on('tool(test-table-operate)', function(obj){
            var data = obj.data;
            if(obj.event === 'del'){
                layer.confirm('真的删除该公告信息？', {icon: 3, title:'提示', offset: '50px'}, function(index){
                    $.ajax({
                        url:'/notice/noticeDeleteByNo?noticeNo=' + data.noticeNo,
                        dataType:"JSON",
        ...
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="noticeNo" name="noticeNo" placeholder="请输入公告号" disabled class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">公告主题</label>
                <div class="layui-input-block">
                    <input type="text" id="noticeName" name="noticeName" placeholder="请输入公告主题" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">公告内容</label>
                <div class="layui-input-block">
                    <input type="tel" id="noticeContent" name="noticeContent" value="" placeholder="请输入公告内容" lay-verify="required" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">发布时间</label>
                <div class="layui-input-block">
                    <input type="text" id="noticeTime" name="noticeTime" value="" placeholder="请输入发布时间" class="layui-input">
                </div>
            </div>
        </form>
    </div>
