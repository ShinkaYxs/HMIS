...
<video class="video-player" preload="auto" autoplay="autoplay" loop="loop">
    <source src="/images/video/workerAdd.mp4" type="video/mp4">
</video>
...
<div class="login" style="height:400px;width:500px;padding: 20px;background-color:rgba(0,0,0,0.5);border-radius: 4px;position:absolute;left: 50%;top: 50%; margin:-220px 0 0 -260px;z-index:99;">
    ...
    <form id="formId" class="layui-form">
        <div class="layui-form-item">
            <input name="workerName" class="layui-input" placeholder="姓名" lay-verify="required" type="text" autocomplete="off" style="padding-left: 40px;">
        </div>
        <div class="layui-form-item">
            <input name="workerAge" class="layui-input" placeholder="年龄" lay-verify="required|number" type="text" autocomplete="off" style="padding-left: 40px;">
        </div>
        <div class="layui-form-item">
            <input name="departmentNo" class="layui-input" placeholder="部门编号" lay-verify="required|number" type="text" autocomplete="off" style="padding-left: 40px;">
        </div>
        <div class="layui-form-item">
        <input name="workerTel" class="layui-input" placeholder="手机号" lay-verify="required|phone|number" type="text" autocomplete="off" style="padding-left: 40px;">
        </div>
        <div class="layui-form-item">
            <input name="workerEmail" class="layui-input" placeholder="邮箱号" lay-verify="required|email" type="text" autocomplete="off" style="padding-left: 40px;">
        </div>
        <div class="layui-form-item" style="color: #fff">
            ...
            <div class="layui-input-block" style="margin-left: 60px;margin-right: 0px;!important">
                <input type="radio" name="workerSex" value="男" title="男" checked>
                <input type="radio" name="workerSex" value="女" title="女" >
            </div>
        </div>
    ...
    layui.use(['form','layer'],function(){
        ...
        $(window).resize(function(){
            if($(".video-player").width() > $(window).width()){
                ...
                $(".video-player").css({"width":$(window).width(),"height":"auto","left":0,"top":"-60px"});
            }else{
