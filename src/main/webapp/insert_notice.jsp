...
<div class="login" style="height:500px;width:400px;padding: 20px;background-color:rgba(0,0,0,0.5);border-radius: 4px;position:absolute;left: 50%;top: 50%; margin:-280px 0 0 -200px;z-index:99;">
    <h1>发布公告</h1>
